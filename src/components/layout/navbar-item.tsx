...
const NavbarItem = ({ link }: Props) => {
  ...
  return (
    <Link
      to={link.href}
      className={cn(
        "group flex flex-col md:flex-row items-center justify-center md:justify-start rounded-md p-2 hover:bg-accent hover:text-accent-foreground md:w-full spacy-y-4",
